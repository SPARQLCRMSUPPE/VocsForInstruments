...
<http://www.w3.org/1999/02/22-rdf-syntax-ns#> a lcgft:gf2014026070 ;
	dc:title "MA-Vokabular Alan Riedel" ;
	dc:date "2020-03-31" ;
	dc:description "Hier finden sich die relevanten Terme für meine MA in Bibl.- u- Inf'wiss. Sie sollten prinzipiell ausschließlich für dieses Projekt verwendet werden" .
