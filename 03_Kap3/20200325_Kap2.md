...
Ich verwende OWL Full! <- informieren…
...
Nachdem bereits vorläufige Namespaces in Form von Präfixen (*ma:*, *rism:*, *taxonomie:*, *mimul*) definiert worden waren, scheint es denkbar, die nun mit RDF ausgezeichneten Terme im Internet zu verankern und somit in das Semantic Web einzubetten. Da sich auch hier kein "Lehrbuch" findet, liegt es nahe, diese analog zu einem bestehenden Vokabular zu bilden.

wichtig ist auch range zu definieren. kann nur verwendet werden mit ma
