...
- [x] *genaue Entsprechung* und *ungefähre Entsprechung* in Anwendungsmodell einpflegen

- [x] in ERM  "Label" rausnehmen [<- warum eigtl.?]

- [x] allgemein: es muss "Stimmton" statt "Kammerton" heißen -> Klasse vgl. MGG "Stimmton":
...
- [x] "relative Stimmung" muss ersetzt werden (durch?)
...
- [x] skos:exactMatch anpassen in Grafik (4_2?)
...
- [x] Änderung der Gliederung: "3.0 Vorarbeiten" oder "Erfassung[/Modellierung?] mit RDF" und "4.0 Integration Semantic Web" oder so.
...
- [x] Literals in Vokabular = alles mit Anführungszeichen. Ändern! (_ _)
...
- [x] nachfolgende Fußnoten: "," statt ":" nach Autor
